...
{
	/* UI */
	GtkBuilder * ui = Meg_Builder_Load("page_section", __func__, __LINE__);
	g_return_if_fail( ui );

	/* Widget */
	GtkWidget * widget, * treeview_section;
	...
	/* Tab Setting */
	g_object_set_data( G_OBJECT(widget), "meg-help-page", g_strdup("Editor/Sections.xml") ); //Set the help page
